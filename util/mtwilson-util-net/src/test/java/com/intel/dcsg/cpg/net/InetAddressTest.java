...
public class InetAddressTest {
    ...
    public void testInetAddress() throws UnknownHostException {
        InetAddress a = InetAddress.getByName("192.168.0.1");
    ...
    public void testInvalidInetAddress() throws UnknownHostException {
        InetAddress a = InetAddress.getByName("192.168.0.1x"); // throws UnknownHostException because we don't have DNS...
    ...
    public void testInetAddressLookup() throws UnknownHostException {
        ...
        log.debug(b.toString()); // would print  "mtwilsondev/192.168.0.1" if it could look it up
    }

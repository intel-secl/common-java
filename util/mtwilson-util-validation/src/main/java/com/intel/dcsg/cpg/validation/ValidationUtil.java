...
public class ValidationUtil {
    ...
    public static boolean isValidWithRegex(String input, String regex) {
        ...
        log.trace("Validating {} against regex {}", input, pattern.pattern());
    ...
    private static void validateWithRegex(String content, String regex) {
        log.trace("Regex annotation: {}", regex);
        Pattern pattern = getPattern(regex);
    ...
    private static void validateWithRegex(String content, Pattern pattern) {
        if (content != null && !content.isEmpty()) {
            log.trace("Validating {} against regex {}", content, pattern.pattern());
            ...
            log.trace("Skipping validating {} against {}", content, pattern.pattern());
        }
    }

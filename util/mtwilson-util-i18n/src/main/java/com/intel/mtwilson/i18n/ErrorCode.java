...
public enum ErrorCode {
   ...
   AS_INVALID_ASSET_TAG_CERTIFICATE_HASH(1030, "Invalid asset tag certificate hash specified."),
    ...
    AS_FLAVOR_NOT_FOUND(1220,"Flavor '%s' not found."),
    AS_DELETE_FLAVOR_ERROR(1221, "Error during Flavor deletion: %s. More information is available in the server log"),  // argument should be  e.getClass().getSimpleName()

...
public class WhiteboardExtensionProvider implements ExtensionProvider {
    ...
    private static void register(String serviceName, Class<?> serviceImplementation) {
        log.trace("Registering implementation {} for interface {}", serviceImplementation.getName(), serviceName);
        ...
        synchronized(whiteboard) {
            ...
            if( serviceImplementations.contains(serviceImplementation) ) {
                log.trace("Implementation {} is already registered for interface {}", serviceImplementation.getName(), serviceName);
            }
            else {
        ...
        log.trace("Registered implementation {} for interface {}", serviceImplementation.getName(), serviceName);
    }

...
public class Login {
    ...
    public static void superuser() {
        ...
        try {
        guardedPassword.setPassword(String.valueOf(random.nextDouble()));
        } catch (IOException | GeneralSecurityException ex) {
            log.error("Exception in login ", ex);
        } 
        init(username, guardedPassword.getInsPassword(), "superuser", "*");
        // login
    ...
    public static void user(String... permissions) {
        ...
        init(username, guardedPassword.getInsPassword(), "user", permissions);
        // login
        UsernamePasswordToken loginToken = new UsernamePasswordToken(username, guardedPassword.getInsPassword());
        SecurityUtils.getSubject().login(loginToken);
        guardedPassword.dispose();
